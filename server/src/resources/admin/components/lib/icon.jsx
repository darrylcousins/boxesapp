...
/**
 * QuestionMark component, path borrowed from somewhere?
 * A question mark in circle
 *
 * @returns {Element} DOM component
 */
const QuestionMarkIcon = ({styleSize, size, view}) => (
  <Icon styleSize={styleSize} size={size} view={view}>
